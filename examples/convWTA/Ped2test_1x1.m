...
%%
opts.modelPath = './model/net-epoch-27.mat';


savePath = ['./data/Ped2_5frame_27epoch_pa' num2str(patch_size) '_str' num2str(stride) '_magthres' num2str(mag_thres_train) '/localSVM'];
