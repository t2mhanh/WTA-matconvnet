...
for numTestFolders = [3 4 14 18 19 21 22 23 24 32]
    ...
    for frame_num = 1:nSam
        ...
        groundTruth = groundTruthAll(:,:,frame_num+5);% +1 for Nfr=1, +3 for Nfr=5
...
%save(fullfile(savePath1,'PixelAbMap_10folders.mat'),'TestFoldersResult')
%% DRAW ROC
% pixel level
...
y = 1 - x;
plot(y,x,'r:')
print('-f1','Ped1_pixel_level','-dpng')
% quit;
