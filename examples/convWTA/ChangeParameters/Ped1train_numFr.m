...
%%%
DataDir = '/nobackup/schtmt/ucsd_data/Flow_data/Ped1Train156x240'
savePath = ['./data_1/Ped1_5frame_27epoch_pa' num2str(patch_size) '_str' num2str(stride) '_magthres' num2str(mag_thres) '_Nfr' num2str(Nfr) '/localSVM'];
