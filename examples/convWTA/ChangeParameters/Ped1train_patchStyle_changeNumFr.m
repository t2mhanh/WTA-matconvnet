...
savePath = ['./data_1/Ped1_5frame_27epoch_patchStyle_pa' num2str(patch_size) '_str' num2str(stride) '_magthres' num2str(mag_thres) '_dim' num2str(dim) '_Nfr' num2str(Nfr) '/localSVM'];
...
net.layers(5).block.pad = [0 0 0 0];
 net.addLayer('pooling', ...
      dagnn.Pooling('method','max', 'poolSize', [pool_size pool_size],'pad',[0 0 0 0],'stride',pool_stride), ...
      'x6', 'x7');
