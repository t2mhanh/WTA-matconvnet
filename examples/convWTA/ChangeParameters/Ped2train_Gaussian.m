% use Gaussian normalization and Gaussian kernel
close all
clear all
clc
...
savePath = './data_1/Ped2_5frame_27epoch_pa24_str12_GaussianStd';
...
global_std  = std(GlobalData,0,1);
 save(fullfile(savePath,'LocalData_Grid12x18.mat'),'dataGrid','global_mean','global_std','-v7.3')
 save(fullfile(savePath,'GlobalData_Grid1x1.mat'),'GlobalData','global_mean','global_std','-v7.3')
 %% train local SVM
...
%standardization
 ...
 save(fullfile(savePath,'localSVMGrid1x1_GlobalMaxMin.mat'),'model','global_mean','global_std')
