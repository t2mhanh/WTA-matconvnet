...
savePath = ['./data_1/Ped1_5frame_27epoch_patchStyle_pa' num2str(patch_size) '_str' num2str(stride) '_magthres' num2str(mag_thres_train) '_dim' num2str(dim) '_Nfr' num2str(Nfr) '/localSVM'];
...
for numTestFolders = 1:36
    ...
    decisionMap = [];
    tstart = tic;
    total_frame = total_frame + nfr - Nfr + 1;
