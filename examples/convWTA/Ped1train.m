...
savePath = ['./data/Ped1_5frame_27epoch_pa' num2str(patch_size) '_str' num2str(stride) '_magthres' num2str(mag_thres) '/localSVM'];
...
%
 % Identify size of a higher level feature map
